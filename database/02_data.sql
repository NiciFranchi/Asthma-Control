...
CREATE PROCEDURE reset_and_fill()
	BEGIN
		...
		,(NULL,1,1,'>2 days/week')
		,(NULL,1,1,'Throughout the day')
		,(NULL,2,2,'<= 1x/month')
		,(NULL,2,2,'> 1x/month')
		,(NULL,2,2,'>= 1x/week')
		,(NULL,3,3,'None')
		,(NULL,3,3,'Some limitation')
		,(NULL,3,3,'Extremely limited')
		,(NULL,4,4,'<= 2 days/week')
		,(NULL,4,4,' >2 days/week')
		,(NULL,4,4,'Several times per day')
		,(NULL,5,5,'0-1/ year')
		,(NULL,5,5,'2 - 3 / year')
		,(NULL,5,5,'>3 / year')
		,(NULL,6,1,'<=2 days /week but no more than once on each day')
		,(NULL,6,1,'>2 days/week or multiple times on <=2 days /week')
		,(NULL,6,1,'Throughout the day')
		,(NULL,7,2,'<= 1x/month')
		,(NULL,7,2,'>= 2x/month')
		,(NULL,7,2,'>= 2x/week')
		,(NULL,8,3,'None')
		,(NULL,8,3,'Some limitation')
		,(NULL,8,3,'Extremely limited')
		,(NULL,9,4,'<= 2 days/week')
		,(NULL,9,4,'>2 days/week')
		,(NULL,9,4,'Several times per day')
		,(NULL,10,5,'> 80% predicted / personal best')
		,(NULL,10,5,'60-80 % predicted/personal best')
		,(NULL,10,5,'< 60 % predicted / personal best')
		,(NULL,10,5,'Not available')
		,(NULL,11,6,'>80%')
		,(NULL,11,6,'75-80%')
		,(NULL,11,6,'<75%')
		,(NULL,11,6,'Not available')
		,(NULL,12,7,'0-1 /year')
		,(NULL,12,7,'>= 2  / year')
		,(NULL,13,1,'<=2 days /week')
		,(NULL,13,1,'>2 days/week')
		,(NULL,13,1,'Throughout the day')
		,(NULL,14,2,'<= 2x/month')
		,(NULL,14,2,'1-3x/week')
		,(NULL,14,2,'>= 4x/week')
		,(NULL,15,3,'None')
		,(NULL,15,3,'Some limitation')
		,(NULL,15,3,'Extremely limited')
		,(NULL,16,4,'<= 2 days/week')
		,(NULL,16,4,'>2 days/week')
		,(NULL,16,4,'Several times per day')
		,(NULL,17,5,'> 80% predicted / personal best')
		,(NULL,17,5,'60-80 % predicted/personal best')
		,(NULL,17,5,'< 60 % predicted / personal best')
		,(NULL,17,5,' Not available')
		,(NULL,18,6,'0')
		,(NULL,18,6,'1-2')
		,(NULL,18,6,'3-4')
		,(NULL,18,6,'Not available')
		,(NULL,19,7,'<= 0.75')
		,(NULL,19,7,'>=1.5')
		,(NULL,19,7,'N/A')
		,(NULL,20,8,'>= 20')
