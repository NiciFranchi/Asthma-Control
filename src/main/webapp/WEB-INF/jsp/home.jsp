...
<jsp:attribute name="header">
    ...
    <jsp:body>
        ...
        hard coded for now, will adjust when API is available (returned calculated control levels + recomendation)
        as part of this, div id topText is left appearing for now -->
        <div class="py-2">
            <div class="container unselectable">
                <div class="row">
                    <div class="col-md-6">
                        <h2 id="hImpairmentText" class="text-center"><b style="font-weight: bold;">Impairment: </b>Well
                            controlled</h2>
                    </div>
                    <div class="col-md-6">
                        <h2 id="hRiskText" class="text-center"><b style="font-weight: bold;">Risk:</b> Well controlled
                        </h2>
                    </div>
                </div>
            </div>
        ...
        <div class="py-2">
            <div class="container">
                <div class="row unselectable">
                    <div class="col-md-12">
                        <p class="lead text-center">Recommended Action for treatment <i>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 panel panel-default" data-emptytext="Enter Action for treatment">
                        <ul id="ulActionTreatment" class="" contenteditable="true" id="treatment_actions">
                            ...
                            <li>If no clear benefit in 4-6 weeks, consider alternative diagnoses or adjusting therapy
                            </li>
            ...
            <div class="py-2">
                <div class="container unselectable">
                    <div class="row">
                        <div class="col-md-12">
                            <p class="">
                                <small>At present, there are inadequate data to correspond frequencies of exacerbations
                                    ...
                                    admission) indicate poorer disease control. For treatment purposes, patients who had
                                    >= 2 exacerbations requiring oral systemic corticosteroids in the past year may be
                                    considered the same as patients who have <b> not-well-controlled</b> asthma, even in
                                    the absence of impairment levels consistent with <b>not-well-controlled</b> asthma.
                                </small>
                            </p>
                        </div>
                    </div>
